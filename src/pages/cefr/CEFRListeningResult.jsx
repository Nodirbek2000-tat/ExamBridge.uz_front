...
import { CheckCircle2, RotateCcw, ChevronLeft, Home, ListChecks, Headphones } from 'lucide-react'
...
export default function CEFRListeningResult() {
      ...
      <div className="h-full flex flex-col bg-white">
        ...
        <div className="flex-1 p-4 max-w-3xl w-full mx-auto">
          <div className="bg-white border border-gray-200 rounded-2xl p-5">
            ...
            <p className="text-sm text-gray-500 mt-1">Refreshdan keyin state yo‘qoladi.</p>
            <button
              type="button"
              onClick={() => navigate('/app/cefr/listening')}
  ...
  const handleTryAgain = async () => {
    ...
    try {
      ...
      navigate(`/exam/cefr/listening/${res.data.attempt_id}?section=${sectionId}&title=${encodeURIComponent(title)}`)
    } finally {
      setRetrying(false)
    }
  }
